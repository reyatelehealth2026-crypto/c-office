...
const PERSONAS = [
  { id:'orchestra', name:'Orchestra', role:'Maestro · Lead Conductor', rarity:'SSR', element:'👑', elementName:'Command', image:'../../assets/images/Orchestra.png', gradient:'linear-gradient(155deg,#fbbf24,#f472b6 35%,#9d5cff 65%,#22d3ee)', level:60, status:'busy', tagline:'Routing goals and delegating to the crew.' },
  { id:'astra', name:'Aira', role:'Mentor · Knowledge Architect', rarity:'SSR', element:'🎓', elementName:'Education', image:'../../assets/images/Aira.png', gradient:'linear-gradient(155deg,#fbbf24,#f472b6 50%,#9d5cff)', level:47, status:'active', tagline:'Designing learning journeys.' },
  { id:'lumen', name:'Luna', role:'Scribe · Content Lead', rarity:'SSR', element:'✒️', elementName:'Narrative', image:'../../assets/images/Luna.png', gradient:'linear-gradient(155deg,#818cf8,#a78bfa)', level:44, status:'idle', tagline:'Ready for content tasks.' },
  { id:'vex', name:'Vivi', role:'Sentinel · Audit & Security', rarity:'SR', element:'🛡️', elementName:'Defense', image:'../../assets/images/Vivi.png', gradient:'linear-gradient(155deg,#f43f5e,#fb7185)', level:41, status:'offline', tagline:'Standing by for audit.' },
  { id:'kai', name:'Kira', role:'Builder · Code Forge', rarity:'SSR', element:'⚡', elementName:'Engineering', image:'../../assets/images/Kira.png', gradient:'linear-gradient(155deg,#22d3ee,#3b82f6)', level:52, status:'busy', tagline:'Full-stack engineering sprint.' },
  { id:'mira', name:'Miku', role:'Growth · Multi-platform Strategist', rarity:'SR', element:'📈', elementName:'Commerce', image:'../../assets/images/Miku.png', gradient:'linear-gradient(155deg,#f472b6,#ec4899)', level:39, status:'active', tagline:'Analyzing campaign metrics.' },
  { id:'echo', name:'Emi', role:'Studio · Visual Craft', rarity:'SR', element:'🎨', elementName:'Creative', image:'../../assets/images/Emi.png', gradient:'linear-gradient(155deg,#34d399,#22d3ee)', level:38, status:'idle', tagline:'Ready for visual tasks.' },
  { id:'nyx', name:'Nana', role:'Intel · Insights Analyst', rarity:'SR', element:'🔍', elementName:'Research', image:'../../assets/images/Nana.png', gradient:'linear-gradient(155deg,#a78bfa,#818cf8)', level:36, status:'active', tagline:'Tracking market trends.' },
  { id:'orbit', name:'Ori', role:'Operations · DevOps Lead', rarity:'R', element:'⚙️', elementName:'Operations', image:'../../assets/images/Ori.png', gradient:'linear-gradient(155deg,#64748b,#94a3b8)', level:34, status:'idle', tagline:'Monitoring infrastructure.' },
];
